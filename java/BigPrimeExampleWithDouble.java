...
public class BigPrimeExampleWithDouble
{
  public final static String BELPHEGORS_PRIME_STRING = "1000000000000066600000000000001";
  // Note if you tack on a 1 to the end of the Double type then this will yield: 12345678987654320
  ...
  public static int ITERATE_TO = 10000000;
  ...
  {    
    ...
    for (int i = 0; i < ITERATE_TO; i++)
    {
      ...
      else if (i == (ITERATE_TO - 1) && (ds.compareTo(new BigDecimal(DOUBLE_REGULAR)) == 0))
      {
	System.out.println("We have a match against a double!");
      }
      /*
